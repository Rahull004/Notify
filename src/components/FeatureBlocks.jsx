        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">SignIn | SignUp</h4>
              <p className="text-gray900-87 text-center">Get started by signing in or signing up to access your notes and features.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Add Notes</h4>
              <p className="text-gray900-87 text-center">Add study notes effortlessly, ensuring all materials are organized.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Editor</h4>
              <p className="text-gray900-87 text-center">Utilize our integrated editor to seamlessly add notes, PDFs, and links.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Personal Notes</h4>
              <p className="text-gray900-87 text-center">Edit and customize your notes with ease, ensuring your thoughts and ideas.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Community Notes</h4>
              <p className="text-gray900-87 text-center">Connect with community to share insights, and expand knowledge together.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">AI Chatbox</h4>
              <p className="text-gray900-87 text-center">Harness the power of AI with our chatbox for quick answers to all questions.</p>
            </div>
